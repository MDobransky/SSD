...
class Xception_G(nn.Module):
    ...
    def __init__(self, extras, num_classes, img_size, phase):
        ...
        super(Xception_G, self).__init__()
        ...
        self.box_sizes = [(30, 60), (111, 162), (213, 264)]
...
def xception_G(num_classes, img_size, phase):
    extras = add_extras(cfg['extras'], 2048)
    model = Xception_G(extras, num_classes, img_size, phase)
    return model
