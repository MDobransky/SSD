...
class Xception_J(nn.Module):
    ...
    def __init__(self, extras, num_classes, img_size, phase):
        ...
        super(Xception_J, self).__init__()
        ...
        self.block3 = Xception_Block(256, 256, 2, 1, start_with_relu=True, grow_first=True)
        ...
        self.block8 = Xception_Block(256, 512, 3, 2, start_with_relu=True, grow_first=True)
        self.block9 = Xception_Block(512, 512, 3, 1, start_with_relu=True, grow_first=True)
        self.block10 = Xception_Block(512, 512, 3, 1, start_with_relu=True, grow_first=True)
        self.block11 = Xception_Block(512, 512, 3, 1, start_with_relu=True, grow_first=True)

        self.block12 = Xception_Block(512, 512, 2, 2, start_with_relu=True, grow_first=False)
        ...
        self.base = [self.conv1, self.conv2, self.block1, self.block2, self.block3, self.block4, self.block5, self.block6, self.block7, self.block8,
                     self.block9, self.block10, self.block11, self.block12, self.conv3, self.conv4]
...
cfg = {
    'extras': [256, 'S', 256, 128, 'S', 256, 128, 256],
}


def xception_J(num_classes, img_size, phase):
    extras = add_extras(cfg['extras'], 512)
    model = Xception_J(extras, num_classes, img_size, phase)
    return model
