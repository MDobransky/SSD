...
class Xception_E(nn.Module):
    ...
    def __init__(self, extras, num_classes, img_size, phase):
        ...
        super(Xception_E, self).__init__()
        ...
        self.block8 = Xception_Block(256, 728, 3, 2, start_with_relu=True, grow_first=True)
...
def xception_E(num_classes, img_size, phase):
    extras = add_extras(cfg['extras'], 2048)
    model = Xception_E(extras, num_classes, img_size, phase)
    return model
