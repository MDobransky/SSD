...
from ssd.lib.data.preprocess import Augment, Crop
from ssd.lib.ssd import SSD

parser = argparse.ArgumentParser()
parser.add_argument("--resume", default="imgnet", type=str, help="Network checkpoint")
...
parser.add_argument('--h', action='store_false', default=True, dest='resume_head', help='Do not resume head, NOT IMPLEMENTED')
