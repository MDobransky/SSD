...
parser.add_argument('--l', action='store_true', default=False, dest='lock_base', help='Lock base, NOT IMPLEMENTED')
...
parser.add_argument("--type", default=None, type=str, help="xception version A, B, C, D...")
